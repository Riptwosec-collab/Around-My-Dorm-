...
export function SearchAssistPanel({
  ...
  if (!showSuggestions && !showIntent && !showRelaxations) return null;

  return (
    <section data-testid="search-assist-panel" className="amd-glass amd-card mt-2 overflow-hidden p-3">
      {showIntent && (
