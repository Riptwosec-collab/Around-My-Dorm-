...
test("API Control Center stays fail-closed before admin login and makes zero Google Places requests", async ({ page }) => {
  ...
  await expect(page.getByTestId("google-api-control-center")).toHaveCount(0);
