...
-- Shared database-level Admin predicate. Keep this in sync with the centralized
-- client Admin gate; maintenance RLS and privileged summary functions reuse it.
...
-- Phase 2A Candidate Staging. Candidate rows are Admin-only maintenance state
-- and are never part of the public place read path.
